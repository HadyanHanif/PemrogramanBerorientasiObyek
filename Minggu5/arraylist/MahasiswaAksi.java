...
public class MahasiswaAksi {
    public static void main(String[] args) {
        ...
        ArrayList<Mahasiswa> mahasiswaList1 = new ArrayList<Mahasiswa>();
       ...
       nilai3.add(3.0);
       mahasiswaList1.add(new Mahasiswa("Budi", "12345", nilai1));
       

       // menampilkan data mahasiswa dan IPK menggunakan Iterator
       Iterator<Mahasiswa> iterator = mahasiswaList1.iterator();
